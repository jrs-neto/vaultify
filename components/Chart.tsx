...
import { calculateAngle, calculatePercentage, convertFileSize } from "@/lib/utils";
  ...
  return (
    <Card className="chart">
      <CardContent className="flex-1 p-0">
        <ChartContainer config={chartConfig} className="chart-container">
          <RadialBarChart
            data={chartData}
            startAngle={90}
            endAngle={calculateAngle(used) + 90}
            innerRadius={80}
            outerRadius={110}
          >
            <PolarGrid
      ...
      <CardHeader className="chart-details">
        <CardTitle className="chart-title">Available Space</CardTitle>
